...
# (module-level execution guarded under __main__ so pytest collection stays instant)
...
if __name__ == "__main__":
    ...
    jg.pump_pressure_relation(
        form_temp, rho_pf, ppf_surf, e41_jp, tube, wellprof, ipr_su, prop_su
    )

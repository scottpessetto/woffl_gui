...
class TestSinglePumpRegression:
    def test_13a_returns_result(self, e41):
        ...
        result = jetpump_solver(
            pwh=e41["surf_pres"], tsu=e41["form_temp"], rho_pf=e41["rho_pf"],
            ppf_surf=e41["ppf_surf"], jpump=jp, wellbore=e41["tube"],
            wellprof=e41["profile"], ipr_su=e41["inflow"], prop_su=e41["res_mix"],
        )
...
class TestBatchRunRegression:
    def test_e41_batch_28_combos(self, e41):
        ...
        jp_list = BatchPump.jetpump_list(
            ["9", "10", "11", "12", "13", "14", "15"], ["A", "B", "C", "D"],
        )
        bp = BatchPump(
            pwh=e41["surf_pres"], tsu=e41["form_temp"], rho_pf=e41["rho_pf"],
            ppf_surf=e41["ppf_surf"], wellbore=e41["tube"], wellprof=e41["profile"],
            ipr_su=e41["inflow"], prop_su=e41["res_mix"], wellname="E-41",
        )

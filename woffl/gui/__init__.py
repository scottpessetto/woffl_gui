"""
GUI package for WOFFL application.

This package contains the graphical user interface components and utilities
for the WOFFL (Well Optimization and Flow Forecasting Library) application.
...
Module Structure:
    ...
    optimization_viz.py   - Multi-well visualization functions
"""

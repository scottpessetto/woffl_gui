"""Power-fluid calibration - PF pressure for a target lift rate, nozzle wear.

Restored to the LIBRARY 2026-08-18. It lived at woffl/gui/pf_calibration.py
and was deleted with the Streamlit app, which was wrong: it never imported
Streamlit and it is pure physics. `calibrate_pf_for_lift` is the engine
behind the JP Wash-Out tool, and `estimate_nozzle_wear` behind the Solver's
nozzle-wear quickfix.

Fork-only (like sim_factories/parallelism), not upstream physics.
"""

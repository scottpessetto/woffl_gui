...
def build_online_table(
    ...
    for well in online_list:
        ...
        row = {
            ...
            "EspHz": display.get("esp_hz", np.nan),
            "EspAmps": display.get("esp_amps", np.nan),
        ...
        def _bench_cols():
            ...
            if last is not None and pd.notna(last.get("last_date")):
                ...
                return {
                    ...
                    "EspHz": last.get("last_esp_hz"),
                    "EspAmps": last.get("last_esp_amps"),
                    "WC": last.get("last_wc"),
            ...
            return {
                ...
                "EspHz": r.get("esp_hz", np.nan),
                "EspAmps": r.get("esp_amps", np.nan),
